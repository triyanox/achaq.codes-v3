...
const ProjectCard = (props: Props) => {
  return (
    <div className="flex w-full flex-col gap-4 h-48 justify-center p-8 hover:bg-gray-200 dark:hover:bg-zinc-900 rounded-lg shadow-sm  hover:scale-110 transition-all duration-300">

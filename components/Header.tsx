...
function Header() {
  ...
  return (
    <section className="fixed flex top-0 h-16 items-center py-2 w-full bg-zinc-50 dark:bg-zinc-900 px-8 md:px-24 xl:px-20 z-50 bg-opacity-40 dark:bg-opacity-40 backdrop-filter backdrop-blur-xl">

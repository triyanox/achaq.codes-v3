...
const BlogPrev = (props: Props) => {
  return (
    <div className="relative flex w-full h-40 md:h-56 justify-center flex-col hover:border-2 border-[#6320EE] dark:border-[#FF6B6B] active:scale-90 transition-all duration-300 ">

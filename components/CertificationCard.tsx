...
const CertificationCard = (props: Props) => {
  return (
    <Link href={props.link} passHref>
      <a target="_blank">
        <div className="flex flex-col gap-1 items-start sm:items-center md:items-start justify-center px-2 md:px-6 py-1 w-full text-black dark:text-white rounded-lg hover:scale-110 hover:bg-gradient-to-r from-[#6E44FF]  to-[#6EE7B7] dark:from-[#EB5160] dark:to-[#3B82F6] animate-gradient-x hover:shadow-xl dark:shadow-[#EB5160] transition-all duration-200">
          {" "}

...
const BlogPrev = (props: Props) => {
  return (
    <div className="relative flex w-full h-40 md:h-56 justify-center flex-col  active:scale-90 p-2 hover:bg-gray-200 dark:hover:bg-zinc-900 rounded-lg shadow-sm  hover:scale-110 transition-all duration-300">

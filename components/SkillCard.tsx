...
const SkillCard = (props: Props) => {
  return (
    <div className="flex justify-start items-center w-full rounded-xl h-40 gap-4 hover:bg-gradient-to-r from-[#6E44FF]  to-[#6EE7B7] dark:from-[#EB5160] dark:to-[#3B82F6] animate-gradient-x transition-all duration-300 hover:shadow-xl shadow-rose-400 dark:shadow-[#EB5160]">
